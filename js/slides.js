(function () {
  ...
  /* --- よろず案内 --- */
  function slide26() {
    return '<section class="slide" data-section="wrap" data-title="よろず支援拠点のご案内" data-notes="よろず支援拠点は今日みたいなAI・デジタル活用以外にも、資金繰りや労務・マーケティングなど色んな専門家が担当しています。他に気になることがあれば、その分野の担当をご紹介することもできますので、気軽にご相談ください。（少し間）次回も来ていただければ、続きを一緒に考えます。受付でご予約いただければと思います。">' +
      H('よろず支援拠点でできること') +
      '<div class="slide-content">' +
        '<ul class="s-list">' +
          ...
          '<li class="s-list-sub">次回の予約は受付スタッフにお声がけください</li>' +
        '</ul>' +
      '</div>' +
    '</section>';
  }
